...
<head>
	...
	<link rel="stylesheet" href="/css/agreement-middle.css" type="text/css">
	</link>
	<script src="/js/ajax/ajaxID.js" type="text/javascript" defer></script>
	<script src="https://code.jquery.com/jquery-3.5.1.js"
		integrity="sha256-QWo7LDvxbWT2tbbQ97B53yJnYU3WhH/C8ycbRAkjPDc=" crossorigin="anonymous" defer></script>
		...
		<div class="signup__form">
			<form action="/member/signupProc" method="post" id="ckpoint">
				...
				<div class="signup__pwd">
					<input type="password" placeholder="비밀번호" name="pw" id="pw" maxlength="10">
					<p class="pw__text"></p>
				</div>
				<div class="signup__pwd_check">
					<input type="password" placeholder="비밀번호 재확인" name="cpw" id="cpw" maxlength="10">
					<p class="cpw__text"></p>
				</div>
				<div class="signup__name">
					<input type="text" placeholder="이름" name="name" id="name" maxlength="6">
					<p class="name__text"></p>
				</div>
				<div class="signup__phone">
					<input type="tel" placeholder="전화번호" name="tel" id="tel" maxlength="11">
					<p class="tel__text"></p>
				</div>
