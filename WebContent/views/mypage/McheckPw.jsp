...
<body>
	...
	<section>
		<form action="/mypage/McheckPwProc" method="post" id="checkPoint"
	...
	<footer>
		<div class="agreement__form">
			<a href="#" onclick="createFeed()">이용안내</a> <a href="#"
				onclick="createFeed()">개인정보방침</a> <a href="#" onclick="createFeed()">제휴문의</a>
		</div>
	</footer>
</body>
</html>