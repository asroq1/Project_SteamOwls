...
public class ProductDao {
	...
	public int pAdd(ProductVo productVo) {
		...
		try {
			pstmt = con.prepareStatement("insert into owls_product_tb(product_name, product_detail, product_people, product_price, product_image, product_originalImage, product_imagePath) values(?, ?, ?, ?, ?, ?, ?)");
